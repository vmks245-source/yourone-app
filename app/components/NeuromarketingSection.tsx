...
export default function NeuromarketingSection() {
  ...
  return (
    <section id="methodology" className="py-24 relative overflow-hidden bg-slate-50/60 border-y border-slate-200/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-50 border border-purple-200 text-purple-700 text-xs font-mono font-semibold uppercase tracking-wider">
            <Brain className="w-4 h-4 text-purple-600" /> Behavioral Science & AI Engineering
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6">
            <div className="p-8 rounded-3xl bg-white border border-slate-200 backdrop-blur-2xl relative group overflow-hidden shadow-xl">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-indigo-500/10 to-purple-500/0 rounded-full blur-2xl" />
              ...
              <div className="flex items-center justify-between pb-6 border-b border-slate-100 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500 ml-2 font-mono">neuromarketing_engine.v4</span>
                </div>
                <span className="text-xs text-indigo-700 font-mono bg-indigo-50 px-2.5 py-1 rounded-full border border-indigo-200 flex items-center gap-1 font-semibold">
                  <Activity className="w-3 h-3 animate-pulse text-indigo-600" /> Live Heatmap Analysis
                </span>
              </div>
              ...
              <div className="space-y-4 relative">
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-indigo-200 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-indigo-100 border border-indigo-200 flex items-center justify-center text-indigo-700">
                      <Zap className="w-5 h-5" />
                    </div>
                    <div>
                      <div className="text-xs text-slate-500 uppercase font-mono">Conversion Node #1</div>
                      <div className="text-sm font-semibold text-slate-900">Hero Call-To-Action Optimization</div>
                    </div>
                  </div>
                  <span className="text-xs font-mono text-emerald-700 font-bold bg-emerald-100 px-2.5 py-1 rounded-md border border-emerald-200">
                    +48.2% CTR
                  </span>
                </div>

                <div className="p-4 rounded-xl bg-slate-50 border border-purple-200 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs text-slate-500 uppercase font-mono">Attention Anchor #2</div>
                      <div className="text-sm font-semibold text-slate-900">Neuromarketing Visual Contrast</div>
                    </div>
                  </div>
                  <span className="text-xs font-mono text-emerald-700 font-bold bg-emerald-100 px-2.5 py-1 rounded-md border border-emerald-200">
                    89% Eye Lock
                ...
                <div className="p-4 rounded-xl bg-slate-50 border border-pink-200 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-pink-100 border border-pink-200 flex items-center justify-center text-pink-700">
                      <Brain className="w-5 h-5" />
                    </div>
                    <div>
                      <div className="text-xs text-slate-500 uppercase font-mono">Cognitive Friction #3</div>
                      <div className="text-sm font-semibold text-slate-900">Zero-Click App Onboarding</div>
                    </div>
                  </div>
                  <span className="text-xs font-mono text-emerald-700 font-bold bg-emerald-100 px-2.5 py-1 rounded-md border border-emerald-200">
                    99.1% Completion
              ...
              <div className="mt-6 pt-6 border-t border-slate-100 grid grid-cols-3 gap-2 text-center">
                <div>
                  <div className="text-xl font-bold font-mono text-slate-900">45ms</div>
                  <div className="text-[10px] text-slate-500 uppercase font-medium">First Visual Impression</div>
                </div>
                <div>
                  <div className="text-xl font-bold font-mono text-emerald-600">3.4x</div>
                  <div className="text-[10px] text-slate-500 uppercase font-medium">Higher LTV Rate</div>
                </div>
                <div>
                  <div className="text-xl font-bold font-mono text-indigo-600">0.2s</div>
                  <div className="text-[10px] text-slate-500 uppercase font-medium">Interactive Reaction</div>
                </div>
              </div>
