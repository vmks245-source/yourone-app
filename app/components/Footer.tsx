...
export default function Footer() {
  return (
    <footer className="relative bg-[#02050e] border-t border-white/10 pt-20 pb-12 overflow-hidden">
      {/* Glow Ambient background */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-t from-indigo-900/10 via-purple-900/5 to-transparent blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-3 text-slate-400 pt-2">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:text-white hover:border-indigo-500/50 transition-all">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:text-white hover:border-indigo-500/50 transition-all">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:text-white hover:border-indigo-500/50 transition-all">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/refund" className="hover:text-slate-400 transition-colors">Client SLA & Guarantees</Link>
          </div>
        </div>
      </div>
    </footer>
