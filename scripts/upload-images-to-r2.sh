...
echo "=== Uploading images → R2 bucket: $BUCKET ==="
ok=0; fail=0
...
echo ""; echo "Done: $ok uploaded, $fail failed"
echo "URL: https://pub-558ced66b1054a088b11443d1cd1ea5d.r2.dev/{id}_{n}.jpg"
